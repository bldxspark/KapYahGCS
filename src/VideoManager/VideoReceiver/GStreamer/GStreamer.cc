...
// GST_PLUGIN_STATIC_DECLARE(opengl);   // Disabled: not present in current Android SDK
    ...
    namespace GStreamer
{
    ...
    void _registerPlugins()
    {
        ...
        // GST_PLUGIN_STATIC_REGISTER(opengl);   // Disabled: not present in current Android SDK
